...
![dashboard](https://raw.githubusercontent.com/zaiyemeiyou404/task-pulse/main/public/screenshots/dashboard-home-v2.png)
...
- 新增**网站制作**分类与筛选标签，支持网页制作类任务的独立追踪。
- 任务详情页新增**人工改标签 / 改分类**入口，可直接手动调整任务类别与归档分组。
- 任务详情页的分类/分组下拉框已统一为**暗色面板风格**，避免弹出层过白影响观感。
- 修正总览页 `Task Pulse 完善` 分组的仓库链接为：`https://github.com/zaiyemeiyou404/taskPulse`
...
![dashboard-expanded](https://raw.githubusercontent.com/zaiyemeiyou404/task-pulse/main/public/screenshots/dashboard-expanded.png)
...
![detail](https://raw.githubusercontent.com/zaiyemeiyou404/task-pulse/main/public/screenshots/detail.png)
...
- 人工归档：支持在详情页直接修改任务分组与类别标签，便于修正误分类任务

![detail-events](https://raw.githubusercontent.com/zaiyemeiyou404/task-pulse/main/public/screenshots/detail-events.png)
...
| `/api/tasks/[taskId]` | PATCH | 手动更新任务分组/类别标签 |
